    ...
    function l() {
        ...
        if (e.question_number++, e.question_number == e.global_parameter_json[0].fields.question_count) {
            ...
            1 == e.election_json[i].fields.has_visits ? function(e) {
                $("#game_window").html('        <div class="game_header">            <h2>NEW CAMPAIGN TRAIL</h2>        </div>        <div id="main_content_area">            <div id="map_container"></div>            <div id="menu_container">                <div id="overall_result_container">                    <div id="overall_result">                        <h3>ESTIMATED SUPPORT</h3>                        <p>Click on a state to view more info.</p>                    </div>                </div>                <div id="state_result_container">                    <div id="state_info">                        <h3>STATE SUMMARY</h3>                        <p>Click/hover on a state to view more info.</p>                        <p>Precise results will be available on election night.</p>                    </div>                </div>            </div>        </div>        <div id="map_footer_visit"><p class="blank_spot"></p>        <p class="visit_text">Use this map to click on the next state you wish to visit. Choose wisely             and focus your efforts where they will have the most impact.</p>        </div>        ');
                var t = r(e, 1);
                ...
                for (var s = 0; s < e.states_json.length; s++) {
                    for (var n = [], l = 0; l < t.length; l++)
                        if (t[l].abbr == e.states_json[s].fields.abbr) {
                            npp = []
                            for (var o = 0; o < t[l].result.length; o++) {
                                n.push({

                        ...
                        for (l = 0; l < e.state_issue_score_json.length; l++)
                            if (e.state_issue_score_json[l].fields.state == e.states_json[s].pk)
                                for (o = 0; o < e.issues_json.length; o++)
                                    ...
                                    } var f = "                    <h3>STATE SUMMARY</h3>                    <p>" + e.states_json[s].fields.name + "</p>                    <ul>" + u + "</ul>                    <p>Electoral Votes: " + e.states_json[s].fields.electoral_votes + "</p>" + "</p>                    <ul>" + u + "</ul>                    <p>Popular Votes: " + e.states_json[s].fields.popular_votes + "</p>";
                        $("#state_info").html(f);
                        break
                    }
            },

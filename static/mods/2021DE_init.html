...
function displayPage(pageNumber) {
  ...
  if (nextButton) {
    ...
    nextButton.innerHTML = (currentPage === 0) ? 'Full Biography' : 'Next';
  }
...
function paginateContent() {
  ...
  // Check if pagination has been applied
  if (contentDiv.querySelector('.pagination-applied')) {
    return;
  }
  ...
  paragraphs.forEach(paragraph => {
    charCount += paragraph.textContent.length;

    if (charCount <= maxCharsPerPage && (paragraphsCount === 0 || pages.length > 0)) {
      page.push(paragraph);
      paragraphsCount +=1;
    } else {
      pages.push(page);
      page = [paragraph]; // Start new page
      charCount = paragraph.textContent.length; // Reset char count
    }
  });

  if (page.length > 0) {
    pages.push(page); // Push last page
  }
  ...
  // Add marker indicating pagination has been applied
  const paginationMarker = document.createElement('div');
  paginationMarker.style.display = 'none';
  paginationMarker.className = 'pagination-applied';
  contentDiv.appendChild(paginationMarker);
}
   ...
   tooltipList = [
        {searchString: "Helmut Kohl", explanationText: "CDU chancellor of Germany, from 1982-1998. Had the longest tenure of any chancellor, at 5870 days. Nicknamed “Chancellor of Unity”, due to overseeing the swift reunification of East and West Germany, and having a hand in European integration. Sometimes also criticized for the sluggishness of his administration."},
        {searchString: "Gutmenschen", explanationText: "“Good-People”. Term usually associated with the Right Wing: sarcastic expression for a multiculturalist person, wanting to help people from other countries by bringing them to Germany."},
        {searchString: "Hubert Ulrich", explanationText: "Longtime chair of The Greens in the Saarland (2002-2017). Was involved in local and state politics since the 80’s, as a vehement opponent against coal."},
        {searchString: "Jeanne Dillschneider", explanationText: "Chair of the Green Youth in the Saarland (2017-2019, since 2020) and chair of the Greens in the Saarland (since 2023)."},
        {searchString: "Kevin Kühnert", explanationText: "Former chair of the Jusos (2017-2021), the youth organization of the SPD. Quite leftwing, came to national prominence for his opposition to the Grand Coalition in 2018, as well as several controversial statements on reappropriating BMW. Has become quite influential, being one of the masterminds behind the NoWaBo/Esken leadership victory, even making it up to the post of General-Secretary of the SPD at the end of 2021."},
        {searchString: "Von hier an anders: Eine politische Skizze", explanationText: "“Different from here on out: A political sketch”. Book by Robert Habeck, quite well received."},
        {searchString: "Neue Ostpolitik", explanationText: "“New Eastern Policy” - influential Foreign Policy regime by Willy Brandt, SPD chancellor from 1969-1975. Included detente with Eastern Europe, a de facto recognition of East Germany and a historic trip to Poland, where he earnestly apologized for the brutal German occupation of the country during World War 2."},
        {searchString: "Dietmar Woidke", explanationText: "SPD Minister-President of Brandenburg, since 2013. Governs the state in Red-Red coalitions and in a Kenia coalition. Grew up on an East German farm and is almost 2 Meters tall."},
        {searchString: "Schwanzvergleich", explanationText: "German, “dick measuring contest”."},
        {searchString: "Andrea Nahles", explanationText: "Chair of the Federal Agency of Work since 2022. Was SPD party chair from 2018-2019, with an illustrious career preceding it. Was pretty controversial in the party, suddenly and frustratedly quitting her leadership positions in 2019, after the catastrophic results of the SPD in the European Elections."},
        ...
        {searchString: "Helmut Schmidt", explanationText: "SPD chancellor from 1974 to 1982. Governed in a Social-Liberal coalition alongside the FDP, commanding a moderate course, especially on Foreign Policy, until his coalition partner abandoned him mid-term for the CDU, beginning the 16year long chancellorship of Helmut Kohl."},
        {searchString: "Stephan Weil", explanationText: "SPD Minister President of Lower Saxony (Since 2013) and former Mayor of Hanover. Governed with Greens and CDU at different points. Quite well regarded, and was considered a possible candidate for leadership on the national level, although he declined every opportunity."},
        {searchString: "Gesine Schwan", explanationText: "Academic and longtime member and chair of the SPD Basic-Values-Commission. Was a candidate for Federal President in 2004 and 2009. A leading voice of the party’s left wing, not uncontroversial."},
        {searchString: "Claudia Moll", explanationText: "SPD MP in the Bundestag since 2017 and former caregiver for the Caritas. An outspoken advocate for Elder Care and Social Care. A moderate, known for her no-bullshit, hard-edge personality and love for carnival."},
        {searchString: "Bärbel Bas", explanationText: "SPD MP in the Bundestag since 2009, as a prominent member of the party’s left wing. Worked in the health insurance industry before winning her direct mandate four times. After being Parliamentarian Manager of her party in the Bundestag, she became the parliament’s President in 2021."},
        {searchString: "nefarious revenge", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_2.webp>"},
        {searchString: "such a gesture", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_3.jpg> Great. Just great."},
        {searchString: "Peer Steinbrück’s", explanationText: "Centrist SPD politician, also former Minister of Finances (2005-2009). Was SPD chancellor candidate in 2013, handily defeated by Angela Merkel."},
        {searchString: "Jetzt. Wie wir unser Land erneuern", explanationText: "“Now. How we renew our country”"},
        {searchString: "The Campaign Trail", explanationText: "good game"},
        {searchString: "Taliban", explanationText: "Islamistic terror organization, ruling over Afghanistan. Founded from mujahedeen, during the war against the Soviet Union. Sheltered the terrorists responsible for the 9/11 attacks, and probably the single most well known terror group."},
        {searchString: "Hans-Georg Maaßen", explanationText: "Former president of the Federal Office for the Protection of the Constitution. Retired in 2018, after laying an absurd focus on left-wing radicalism, showing suspiciously less attention to the right wing. Afterwards, he made several antisemitic, far-right and even conspiratory statements. Currently chair of the Werte-Union, a right-wing CDU suborganization."},
        {searchString: "Frank Ullrich", explanationText: "Former East German biathlon star and trainer for the German national biathlon and cross-country skiing teams. Won a Bundestag-Mandate for the SPD in a high profile race against Hans-Georg Maaßen. Has since been chair of the sports committee."},
        {searchString: "Franziska Giffey", explanationText: "Former SPD Minister for Families, Seniors, Women and Youth (2018-2021) and mayor of Berlin (2021-2023). A prominent member of the centrist SPD wing. Has experienced controversies around plagiarizing in her doctoral thesis."},
        {searchString: "Manuela Schwesig", explanationText: "SPD Minister-President of Mecklenburg-Vorpommern (since 2017). Was Minister for Families, Seniors, Women and Youth before (2013-2017). Has been an advocate against child pornography and for cooperation with Russia, especially on Nord Stream 2."},
        {searchString: "Meckpom", explanationText: "Mecklenburg-Vorpommern"},
        {searchString: "Wolfgang Schmidt", explanationText: "Minister of Special Tasks and chief of the Chancellery since 2021. Is a trusty friend and advisor at Olaf Scholz’ side, as his chief of staff, state councilor and state secretary. Became the target of a lawsuit when he leaked the partisanship of a prosecutor investigating the Ministry of Finances."},
        {searchString: "Wolfgang", explanationText: "Wolfgang Schmidt, Minister of Special Tasks and chief of the Chancellery since 2021. Is a trusty friend and advisor at Olaf Scholz’ side, as his chief of staff, state councilor and state secretary. Became the target of a lawsuit when he leaked the partisanship of a prosecutor investigating the Ministry of Finances."},
        {searchString: "FIU", explanationText: "Financial Intelligence Unit, suborganization under the Ministry of Finance, dedicated to fighting international tax evasion and tax fraud."},
        {searchString: "Federal Constitutional Court", explanationText: "Highest court of the land, composed of 16 nonpartisan, parliamentary elected judges, divided in two chambers. Founded in 1951 as a reaction to the fate of the Weimar Republic. Generally enjoys high levels of trust."},
        {searchString: "Bettina Jarasch", explanationText: "Green Senator for the Environment in Berlin (2021-2023). Before that, was the Green candidate in the mayoral race of Berlin in 2021. Was a journalist before, and has extensive media contacts. Is an actively practicing catholic and considered part of the moderate Realo-wing."},
        {searchString: "Merkel-candidate", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_4.webp>"},
        {searchString: "Merkel-Raute", explanationText: "Widely known gesture, often used by Merkel. Consists of holding your hands below the chest, letting the fingertips of both hands touch, tilting the thumbs to the side, creating a diamond-like shape in between. Synonymous with prudence, calmness and moderation."},
        {searchString: "SZ-magazine", explanationText: "Süddeutsche Zeitung Magazin (South German Newspaper - Magazine), supplement of the <i>Süddeutsche Zeitung</i>, one of the biggest newspapers in Germany."},
        {searchString: "Kabul", explanationText: "Capital of Afghanistan."},
        ...
        {searchString: "PL", explanationText: "“Parliamentarian Left”, Subgroup of leftist SPD-Parliamentarians in the Bundestag. Began during the 60’s and 70’s as somewhat oppositional to the SPD-led executive. Is keynesianist, pacifist and follows a “leftist pragmatism of gradual improvements”. Its prominent members became quite powerful since 2018, occupying leadership roles both formally and informally."},
        ...
        {searchString: "ostalgics", explanationText: "“Ostalgie”, or “Eastalgia” is nostalgia towards the culture and society of the old DDR, the regime governing East Germany from 1949-1990. Most “ostalgic” East Germans miss the sense of social cohesion, some institutions or certain cultural icons, and feel left behind economically and socially after reunification."},
        ...
        {searchString: "smurfy grin", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_5.png> :3"},
        {searchString: "smurfily grinning", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_5.png> >:3"},
        ...
        {searchString: "Social Market Economy", explanationText: "Germany’s traditional economic system; consisting of a free market economy buoyed by a welfare state. Originally envisioned by Minister of the Economy Ludwig Erhard (CDU, 1949-1963)."},
        ...
        {searchString: "Laschet’s Lacher", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_6.webp> I’m sure it was very funny."},
        {searchString: "boyishly laughing", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_6.webp> I’m sure it was very funny."},
        ...
        {searchString: "Grand coalition", explanationText: "Coalition consisting of Germany’s traditional two major parties, the SPD and the CDU/CSU. Has governed from 1966-1969, 2005-2009 and 2013-2021."},
        ...
        {searchString: "Putinversteher", explanationText: "“Putin understander”: derogatory word for a person sympathizing with the Russian government, or thinking they can be reasoned with."},
        ...
        {searchString: "Bubatz", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_7.jpg> episch"},
        ...
        {searchString: "Beleidigte Leberwurst", explanationText: "“offended liver sausage” - German expression for someone who is childishly sulking."},
        ...
        {searchString: "Genosse Olaf", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_8.jpg> Freundschaft, Genosse!"},
        {searchString: "Terror-Shrek", explanationText: "<img src=https://jetsimon.com/cts-media/public/2021DE_init_9.jpg> That’s not even half of it. Don’t look up “Markus Söder Gandhi\". Worst mistake of my life."},
        ...
        {searchString: "Jusos", explanationText: "“JungsozialistInnen”, “Young Socialists”. The youth organization of the SPD. Noticeably more left-wing than the national party. Has gained in influence over the last few years, while being led by the prominent Kevin Kühnert."},
        {searchString: "Green Youth", explanationText: "Youth organization of The Greens. Culturally and economically quite leftist. A good amount of overlap with Fridays For Future organizers and other ecological and culturally progressive organizations."},
        ...
        {searchString: "Winfried Kretschmann", explanationText: "Green Minister-President of Baden-Württemberg (since 2011). As the first Green Minister-President, he’s a leading part of their ecological-conservative wing and is partly known for his eccentric swabian dialect."},
        {searchString: "Kretschmann", explanationText: "Winfried Kretschmann, Green Minister-President of Baden-Württemberg (since 2011). As the first Green Minister-President, he’s a leading part of their ecological-conservative wing and is partly known for his eccentric swabian dialect."},
        ...
        {searchString: "Wissler", explanationText: "Janine Wissler, party co-chair of Die Linke since 2021. One of the founding members of the SPD splinter group WASG, who split from the Social Democrats due to the neoliberal policies of Gerhard Schröder in 2005. They then merged with the PDS to become Die Linke (The Left) in 2007."},
        {searchString: "Christian Lindner", explanationText: "Party chair of the liberal FDP since 2013, nowadays Minister of Finance (since 2021). Known for his fiery rhetorical skills, his fiscal conservatism and as somewhat of a heartthrob. He led the FDP back into the Bundestag in 2017, with a strong 10%."},
        {searchString: "Lindner", explanationText: "Christian Lindner, party chair of the liberal FDP since 2013, nowadays Minister of Finance (since 2021). Known for his fiery rhetorical skills, his fiscal conservatism and as somewhat of a heartthrob. He led the FDP back into the Bundestag in 2017, with a strong 10%."},
        ...
        {searchString: "Weidel", explanationText: "Alice Weidel, top candidate of the AfD in 2017 and 2021. Controversial for her remarks on “headscarf-girls and alimented Knife-Men”, talking about muslims. Interestingly, she’s in a civil partnership with a Sri Lankan woman, raising two sons in Switzerland."},
        {searchString: "Alexander Dobrindt", explanationText: "CSU Top candidate in Bavaria, former CSU General Secretary and Traffic Minister (2013-2017). He was known as “the most modern General Secretary of the country”. Also known for his strong critiques of the Greens and The Left as anti-democratic."},
        {searchString: "Paul Ziemiak", explanationText: "CDU General Secretary (2018-2022). Quite young, and chosen by Kramp-Karrenbauer as an outreach to conservatives. Born in communist Poland, his parents emigrated in 1988 due to his German heritage."},
    ...
    async function appendStyle() {
        ...
        if (!document.querySelector('#radio-option-style')) {
            ...
            input[type="radio"]:checked:after {
                content: "";
                display: inline-block;
                background-image: url("https://jetsimon.com/cts-media/public/2021DE_init_10.png");
...
.mytooltip:hover .bubble-bottom-left:after {
    ...
    height:200px;
    width:auto;
    margin-right: 20px; /* To give some space between the image and the text */
    margin-bottom: 20px; /* To ensure there's space between the image and any content below */
}
#election_summary,
#candidate_summary{
    overflow: visible;
...
campaignTrail_temp.achievements = {
    ...
    "An even grander coalition": {
        "image": "https://i.ibb.co/yQ1vFys/kenya-cropped.png",
        "description": "Form the Kenya-coalition.",
        "cannotBeCheated": true
    },
    "Progressive Compromise": {
        "image": "https://i.ibb.co/RQC87YP/traffic-cropped.jpg",
        "description": "Form the Traffic Light-coalition.",
        "cannotBeCheated": true
    },
    "Land of Compromises": {
        "image": "https://i.ibb.co/pWkJksV/germany-cropped.png",
        "description": "Form the Germany-coalition.",
        "cannotBeCheated": true
    },
    "Lessons Learned": {
        "image": "https://i.ibb.co/4fsqbYw/jamaica-cropped.jpg",
        "description": "Form the Jamaica-coalition.",
        "cannotBeCheated": true
    },

    "Leftist Unity": {
        "image": "https://i.ibb.co/RgQxPnR/RRG-cropped.png",
        "description": "Form the Red-Red-Green-coalition.",
        "cannotBeCheated": true
    },
    "No escape from the inevitable": {
        "image": "https://i.ibb.co/3SMjs36/Gro-Ko-cropped.png",
        "description": "Form another Grand Coalition.",
        "cannotBeCheated": true
    },
    "Modern Times": {
        "image": "https://i.ibb.co/jwh6qRk/Black-Green-cropped.png",
        "description": "Form the Black-Green-coalition.",
        "cannotBeCheated": true
    },
    "Unforeseen comeback": {
        "image": "https://i.ibb.co/0nfKBGM/Red-Green-cropped.png",
        "description": "Form the Red-Green-coalition.",
        "cannotBeCheated": true
    },
    "Dream-Team": {
        "image": "https://i.ibb.co/mTstLV5/Black-Yellow-cropped.png",
        "description": "Form the Black-Yellow-coalition. (Any difficulty)",
        "cannotBeCheated": true
    },
    "Firewall burned down": {
        "image": "https://i.ibb.co/nPfC27b/bahamas-cropped.png",
        "description": "Form the Bahamas-coalition.",
        "cannotBeCheated": true
    },
    "Total chaos": {
        "image": "https://i.ibb.co/ZK43cyT/chaos-cropped.png",
        "description": "Have the parliament erupt in chaos over your coalition.",
        "cannotBeCheated": true
    },
    "Novelty": {
        "image": "https://i.ibb.co/YNG447m/novelty-cropped.png",
        "description": "On any difficulty, form a rare coalition (Black-Blue, Social-Liberal, Red-Red, Green-Left, Green-Yellow)",
        "cannotBeCheated": true
    },
    "Frischer Wind": {
    "image": "https://i.ibb.co/cLmnHwp/image1-cropped.jpg",
    "description": "As Baerbock, win with maximal Likeability.",
    "cannotBeCheated": true
    },
    "The Mirror": {
        "image": "https://i.ibb.co/tM8q6yg/image2-cropped.jpg",
        "description": "As Baerbock, witness a Habeck win",
        "cannotBeCheated": true
    },
    "I'm Still Standing": {
        "image": "https://i.ibb.co/h9n8Wbs/image3-cropped.jpg",
        "description": "As Baerbock, win despite suffering three scandals.",
        "cannotBeCheated": true
    },
    "Der Zuhörer": {
        "image": "https://i.ibb.co/TmWrfTq/image4-cropped.jpg",
        "description": "As Habeck, win with maximal Patience.",
        "cannotBeCheated": true
    },
    "Bringer of Democracy": {
        "image": "https://i.ibb.co/4dM5Ts6/image5-cropped.png",
        "description": "As Habeck, win Thuringia.",
        "cannotBeCheated": true
    },
    "Ahead of time": {
        "image": "https://i.ibb.co/mqQBPyb/image6-cropped.jpg",
        "description": "As Habeck, take two prophetic stances.",
        "cannotBeCheated": true
    },
    "We want Climate Justice!": {
        "image": "https://i.ibb.co/PTqXvSW/image7-cropped.jpg",
        "description": "Have Luisa Neubauer appear with you.",
        "cannotBeCheated": true
    },
    "Consolation Price": {
        "image": "https://i.ibb.co/ZWD0nRf/image26-cropped.png",
        "description": "As Greens, lose the election but win the Berlin mayoral race.",
        "cannotBeCheated": true
    },
    "Der Staatsmann": {
        "image": "https://i.ibb.co/4dXtZSN/image8-cropped.jpg",
        "description": "As Laschet, win with maximal Statesmanship.",
        "cannotBeCheated": true
    },
    "Landesvater": {
        "image": "https://i.ibb.co/t4LP4Nf/image9-cropped.jpg",
        "description": "As Laschet, surpass your vote share in the NRW state elections (>33%).",
        "cannotBeCheated": true
    },
    "Having the last laugh": {
        "image": "https://i.ibb.co/DfMmdbp/lacher-cropped.jpg",
        "description": "As Laschet, win after laughing at the floods.",
        "cannotBeCheated": true
    },
    "Würfelarmin": {
        "image": "https://i.ibb.co/P1ptCM1/image10.jpg",
        "description": "As Laschet, cheat.",
        "cannotBeCheated": false
    },
    "Gradaus Kanzler": {
        "image": "https://i.ibb.co/85bhwFT/image11-cropped.jpg",
        "description": "As Söder, win with minimal Opportunism.",
        "cannotBeCheated": true
    },
    "Bavarian Strongman": {
        "image": "https://i.ibb.co/5YwcxKR/image12-cropped.jpg",
        "description": "As Söder, opportunistically strongman yourself to victory in the debate.",
        "cannotBeCheated": true
    },
    "O'zapft is!": {
        "image": "https://i.ibb.co/q0fDHH2/image13-cropped.jpg",
        "description": "As Söder, win over 30% of the popular vote.",
        "cannotBeCheated": true
    },
    "Please don't fight": {
        "image": "https://i.ibb.co/KVM3kbP/merkel-Merz-cropped.jpg",
        "description": "Have Merkel and Merz on as advisors at the same time.",
        "cannotBeCheated": true
    },
    "Merkel V": {
        "image": "https://i.ibb.co/F7R9g74/image15-cropped.jpg",
        "description": "As Scholz, win with maximal Merkelism.",
        "cannotBeCheated": true
    },
    "Making History": {
        "image": "https://i.ibb.co/KhZvttS/image16-cropped.jpg",
        "description": "As Scholz, win the election and form a Traffic Light coalition.",
        "cannotBeCheated": true
    },
    "Goodbye Mutti": {
        "image": "https://i.ibb.co/Y0jNHf8/peer-cropped.jpg",
        "description": "As Scholz, flip Merkel off and take over her job.",
        "cannotBeCheated": true
    },
    "Dark Scholz rising": {
        "image": "https://i.ibb.co/31XKwY3/image18-cropped.jpg",
        "description": "As Scholz, give in to dark impulses.",
        "cannotBeCheated": true
    },
    "Sorry, we didn't code this path": {
        "image": "https://i.ibb.co/G2HLc0q/esken-cropped.jpg",
        "description": "As Scholz, come closest to winning the leadership race.",
        "cannotBeCheated": true
    },
    "Elbhoch- wasser all over again": {
        "image": "https://i.ibb.co/jktTF7c/image20-cropped.jpg",
        "description": "As Scholz, get help from a former chancellor in your crisis response.",
        "cannotBeCheated": true
    },
    "Out of a job": {
        "image": "https://i.ibb.co/ZKmZL5W/image21-cropped.jpg",
        "description": "As Scholz, get fired by Merkel.",
        "cannotBeCheated": true
    },
    "Liberal Ländle": {
        "image": "https://i.ibb.co/fG13SZt/fdp-cropped.png",
        "description": "Have the FDP win a state",
        "cannotBeCheated": true
    },
    "Was it something I said?": {
        "image": "https://i.ibb.co/5YLmSPy/image23-cropped.png",
        "description": "Have three advisors quit during a campaign.",
        "cannotBeCheated": true
    },
    "The Old Dame has passed away": {
        "image": "https://i.ibb.co/LJRpDgD/image24-cropped.jpg",
        "description": "As Greens or CDU, have the SPD land below 12.5%.",
        "cannotBeCheated": true
    },
    "Parliamentary Subterfuge": {
        "image": "https://i.ibb.co/stZDc7c/image27-cropped.jpg",
        "description": "Form a coalition from second place.",
        "cannotBeCheated": true
    }
